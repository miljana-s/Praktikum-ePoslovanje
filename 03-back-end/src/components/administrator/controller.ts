...
import { IAddAdministratorValidator, IAddAdministrator } from './dto/IAddAdministrator';
import { IEditAdministratorValidator, IEditAdministrator } from './dto/IEditAdministrator';
...
export default class AdministratorController extends BaseController {
    ...
    public async getById(req: Request, res: Response) {
        ...
        if( id <= 0) return res.status(400).send("The ID value cannot be er than 1.");
